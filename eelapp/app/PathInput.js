class PathInput extends React.Component {
    constructor(props) {
        ...
        this.changePathOnClick = this.updatePathOnClick.bind(this);
    }
    ...
    render() {
        let recentPaths = this.props.recentPaths.map(i => {
            return (
                <p>
                    <a onClick={e => this.updatePathOnClick(e, i)}>{i}</a>
                </p>
            );
        });
                        ...
                        <nav className="level">
                            <div className="level-item">
                                ...
                                <a
                                    ...
                                    onClick={this.props.scanPath}
                                >
                                    <span className="icon">
                                        <img
                                            src="/app/img/search.svg"
                                            alt="Scan"
                                        />
                                    </span>
                                    {buttonText ? (
